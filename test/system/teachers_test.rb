...
class TeachersTest < ApplicationSystemTestCase
  ...
  test "creating a Teacher" do
    ...
    fill_in "Strong sub", with: @teacher.strong_sub
    fill_in "Strong sub level", with: @teacher.strong_sub_level
    fill_in "Student", with: @teacher.student_id
    fill_in "Weak sub", with: @teacher.weak_sub
    fill_in "Weak sub level", with: @teacher.weak_sub_level
